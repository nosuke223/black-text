...
| `npm run test:e2e:preview` | Firefox・WebKitのプレビュー用スモークテスト |

E2Eテストを初めて実行する環境、またはPlaywrightの更新後は、対応するブラウザを導入する。
...
ゲーム仕様は`docs/04_MVP仕様.md`、段階Aの実装順は`docs/05_段階A実装計画.md`を参照してください。プレイテストを実施する場合は、`docs/06_プレイテスト手順.md`と`docs/07_プレイテスト記録票.md`を使用します。
